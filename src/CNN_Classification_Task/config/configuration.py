...
from CNN_Classification_Task.entity.config_entity import DataIngestionConfig, PrepareBaseModelConfig, PrepareCallbacksConfig
...
class ConfigurationManager:
    ...
    # Setup the configuration of the base model task
    ...
    # Setup the configuration of the callbacks task
